...
(function (global, factory) {
  ...
  function data(element, attribute) {
    for (
      var i = 0, attrs = [attribute, "data-" + attribute]; i < attrs.length; i++
    ) {
  ...
  var matchesFn = elProto.matches || elProto.webkitMatchesSelector ||
    elProto.msMatchesSelector || noop;
  ...
  function within(element, selector) {
    return !isString(selector)
      ? element === selector ||
        (isDocument(selector) ? selector.documentElement : toNode(selector))
  ...
  function delegate(selector, listener) {
    ...
    return function (e) {
      var current = selector[0] === ">"
        ? findAll(selector, e.currentTarget).reverse().filter(
          function (element) {
  ...
  function insertNodes(element, fn) {
    ...
    return element
      ? "length" in element ? toNodes(element).map(fn) : fn(element)
      : null;
  }
  ...
  function position(element) {
    ...
    while (
      parent && (parent === body || parent === documentElement) &&
  ...
  MouseTracker.prototype = {
    ...
    movesTo: function (target) {
      ...
      var diagonals = [[{ x: left, y: top }, { x: right, y: bottom }], [{
        x: left,
        y: bottom,
      }, { x: right, y: top }]];
  ...
  strats.events = strats.created = strats.beforeConnect = strats.connected =
    strats.beforeDisconnect = strats.disconnected = strats.destroy =
      concatStrat;
  ...
  strats.computed = strats.methods = function (parentVal, childVal) {
    return childVal
      ? parentVal ? assign({}, parentVal, childVal) : childVal
      : parentVal;
  };
  ...
  function isInView(element, offsetTop, offsetLeft) {
    ...
    return intersectRect.apply(
      void 0,
      scrollParents(element).map(function (parent) {
  ...
  function scrolledOver(element, startOffset, endOffset) {
    ...
    var elementOffsetTop = offsetPosition(element)[0] -
      ...
      each(dirs, function (ref, prop) {
        ...
        boundaries.some(function (boundary) {
          ...
          if (
            ...
            var centerTargetOffset = targetAttach[dir] === "center"
              ? -targetDim[prop] / 2
              : 0;
  ...
  function hooksAPI(UIkit) {
    ...
    function runUpdates(types) {
      ...
      var loop = function (i) {
        ...
        if (
          !types.has("update") && (!events || !events.some(function (type) {
      ...
      var observer = new MutationObserver(function (records) {
        ...
        if (
          records.some(function (ref) {
            ...
            return (prop === $name
              ? attributes
              : [camelize(prop), camelize(attributeName)]).some(
                function (prop) {
                  return !isUndefined(data[prop]) &&
  ...
  var Togglable = {
    ...
    methods: {
      ...
      isToggled: function (el) {
        ...
        return hasClass(el, this.clsEnter) ? true
        : hasClass(el, this.clsLeave) ? false : this.cls
  ...
  var Accordion = {
    ...
    methods: {
      toggle: function (item, animate) {
        ...
        if (
          !this.collapsible && activeItems.length < 2 &&
    ...
    update: {
      read: function () {
        ...
        var dim = Dimensions.cover(
          {
            width: this.width || el.naturalWidth || el.videoWidth ||
              el.clientWidth,
            height: this.height || el.naturalHeight || el.videoHeight ||
              el.clientHeight,
          },
          {
  ...
  var Container = {
    ...
    computed: {
      container: function (ref) {
        ...
        return container === true && this.$container ||
          container && $(container);
      },
    },
  };
    ...
    methods: {
      positionAt: function (element, target, boundary) {
        ...
        var ref$1 = positionAt(
          element,
          target,
          axis === "x" ? ((flipPosition(this.dir)) + " " + (this.align))
          : ((this.align) + " " + (flipPosition(this.dir))),
          axis === "x"
            ? ((this.dir) + " " + (this.align))
            : ((this.align) + " " + (this.dir)),
          axis === "x" ? ("" + (this.dir === "left" ? -offset$1 : offset$1))
  ...
  var drop = {
        ...
        handler: function () {
          ...
          once(
            ...
            on(document, pointerDown, function (ref) {
              ...
              return !within(target, this$1$1.$el) &&
                once(
                  document,
                  ...
                  function (ref) {
                    ...
                    if (
                      !defaultPrevented && type === pointerUp &&
                      target === newTarget &&
    ...
    methods: {
      show: function (target, delay) {
        ...
        if (
          this.isToggled() && target && this.target && target !== this.target
        ) {
          this.hide(false);
        }
        ...
        if (active$1) {
          ...
          var prev;
          while (
            active$1 && prev !== active$1 && !within(this.$el, active$1.$el)
          ) {
            prev = active$1;
            active$1.hide(false);
          }
    ...
    update: [
...

      {
        read: function (data) {
          ...
          if (
            !columns.length || !this.masonry && !this.parallax ||
            ...
            return column.forEach(function (el, j) {
              return css(
                ...
                !scrolled && !translates
                  ? ""
                  : ("translateY(" +
                    ((translates && -translates[i][j]) + (scrolled
                      ? i % 2 ? scrolled : scrolled / 8
                      : 0)) +
                    "px)"),
              );
            });
  ...
  function getHeight(element) {
    ...
    var height = dimensions(element).height -
  ...
  var heightViewport = {
    ...
    update: {
      read: function (ref) {
        ...
        if (this.expand) {
          ...
          if (this.offsetTop) {
            ...
            var top = ref$1.top;
            minHeight += top > 0 && top < height(window) / 2
              ? (" - " + top + "px")
              : "";
          }
          ...
          if (this.offsetBottom === true) {
            ...
            minHeight += " - " +
              (dimensions(query(this.offsetBottom, this.$el)).height) + "px";
          }
      ...
      write: function (ref) {
        ...
        if (
          this.minHeight && toFloat(css(this.$el, "minHeight")) < this.minHeight
        ) {
    ...
    methods: {
      getSvg: function () {
        ...
        return loadSVG(this.src).then(function (svg) {
          return parseSVG(svg, this$1$1.icon) ||
            Promise$1.reject("SVG not found.");
        });
      },
      ...
      applyAttributes: function (el, ref) {
        ...
        if (
          viewBox && !dimensions.some(function (val) {
            return val;
          })
        ) {
  ...
  function parseSymbols(svg, icon) {
    if (!symbols[svg]) {
      ...
      while ((match = symbolRe.exec(svg))) {
        symbols[svg][match[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' +
          (match[1]) + "svg>";
      }
    }
  ...
  function innerHTML(el) {
    return (el.innerHTML ||
      (new XMLSerializer()).serializeToString(el).replace(
        /<svg.*?>(.*?)<\/svg>/g,
        "$1",
      )).replace(/\s/g, "");
  }
  ...
  var img = {
    ...
    methods: {
      load: function (entries) {
        ...
        this._data.image = getImage(this.dataSrc, this.dataSrcset, this.sizes)
          .then(function (img) {
  ...
  function getSourceSize(srcset, sizes) {
    ...
    var descriptors = (srcset.match(srcSetRe) || []).map(toFloat).sort(
      function (a, b) {
        return a - b;
      },
    );
  ...
  function install$2(ref) {
    ...
    modal.dialog = function (content, options) {
      var dialog = modal(
        '<div class="uk-modal"> <div class="uk-modal-dialog">' + content +
        "</div> </div>",
        options,
      );
    ...
    modal.alert = function (message, options) {
      return openDialog(
        function (ref) {
          ...
          return ('<div class="uk-modal-body">' + (isString(message)
            ? message
            : html(message)) +
    ...
    modal.confirm = function (message, options) {
      return openDialog(
        function (ref) {
          ...
          return ('<form> <div class="uk-modal-body">' + (isString(message)
            ? message
            : html(message)) +
    ...
    modal.prompt = function (message, value, options) {
      return openDialog(
        function (ref) {
          ...
          return ('<form class="uk-form-stacked"> <div class="uk-modal-body"> <label>' +
            (isString(message) ? message : html(message)) +
            '</label> <input class="uk-input" value="' + (value || "") +
  ...
  var navbar = {
        ...
        get: function (ref, $el) {
          ...
          if (this.dropContainer !== $el) {
            $$("." + clsDrop, this.dropContainer).forEach(function (el) {
              ...
              if (
                !includes(dropdowns, el) && dropdown && dropdown.target &&
    ...
    events: [
      {
        ...
        handler: function (ref) {
          ...
          if (
            active && includes(active.mode, "hover") && active.target &&
...

      {
        ...
        handler: function () {
          ...
          if (
            active && includes(active.mode, "hover") &&
...

      {
        ...
        handler: function (_, ref) {
          ...
          if (dir === "bottom") {
            this.transitionTo(
              $el.offsetHeight + toFloat(css($el, "marginTop")) +
    ...
    methods: {
      ...
      getDropdown: function (el) {
        return this.$getComponent(el, "drop") ||
  ...
  function getViewport() {
    return $('meta[name="viewport"]', document.head) ||
        ...
        write: function (data) {
          ...
          this.elements.forEach(function (el) {
            ...
            if (state.show && !state.inview && !state.queued) {
              ...
              data.promise = (data.promise || Promise$1.resolve()).then(
                function () {
                  return new Promise$1(function (resolve) {
              ...
              !state.show && state.inview && !state.queued && this$1$1.repeat
            ) {
        ...
        read: function () {
          ...
          if (scrollTop === max) {
            ...
            this.targets.every(function (el, i) {
              if (
                offset(el).top - offset(getViewport$1(scrollElement)).top -
                    this$1$1.offset <= 0
              ) {
                active = i;
                return true;
    ...
    events: [
      {
        ...
        handler: function () {
          ...
          if (
            !(this.targetOffset !== false && location.hash &&
          ...
          if (target) {
            fastdom.read(function () {
              ...
              if (
                this$1$1.isFixed && elTop + elHeight >= top &&
                elTop <= top + target.offsetHeight
              ) {
                scrollTop(
                  window,
                  top - elHeight - (isNumeric(this$1$1.targetOffset)
    ...
    update: [
      {
        read: function (ref, types) {
          ...
          this.top = Math.max(toFloat(parseProp("top", this)), this.topOffset) -
            this.offset;
...

      {
        ...
        write: function (data, types) {
          ...
          if (
            scroll < 0 || scroll === lastScroll && isScrollUpdate ||
          ...
          if (
            ...
            scroll < this.top ||
            this.showOnUp &&
              (scroll <= this.top || dir === "down" && isScrollUpdate ||
  ...
  var tab = {
    ...
    connected: function () {
      var cls = hasClass(this.$el, "uk-tab-left") ? "uk-tab-left"
  ...
  function waitTransitionend(target) {
    return Promise$1.all(
      children(target).filter(Transition.inProgress).map(function (el) {
        return new Promise$1(function (resolve) {
  ...
  function getTransitionProps(target, nodes, currentProps) {
    var propsTo = nodes.map(function (el, i) {
      return parent(el) && i in currentProps
        ? currentProps[i]
          ? isVisible(el) ? getPositionWithMargin(el) : { opacity: 0 }
          : { opacity: isVisible(el) ? 1 : 0 }
        : false;
    });

    var propsFrom = propsTo.map(function (props, i) {
      var from = parent(nodes[i]) === target &&
    ...
    created: function () {
      ...
      ["start", "move", "end"].forEach(function (key) {
        ...
        this$1$1[key] = function (e) {
          ...
          this$1$1.prevPos = pos !== this$1$1.pos
            ? this$1$1.pos
            : this$1$1.prevPos;
          this$1$1.pos = pos;
    ...
    methods: {
      start: function () {
        ...
        if (this._transitioner) {
          ...
          this.drag += this._transitioner.getDistance() * this.percent *
            this.dir;
      ...
      move: function (e) {
        ...
        if (
          distance === 0 || this.prevPos === this.pos ||
        ...
        var width = this._getDistance(prevIndex, nextIndex) ||
        ...
        if (
          this.index === prevIndex && this.prevIndex !== prevIndex || itemShown
        ) {
        ...
        if (this.dragging) {
          ...
          if (this.index === this.prevIndex) {
            ...
            var dirChange = (isRtl
                  ? this.dir * (isRtl ? 1 : -1)
                  : this.dir) < 0 === this.prevPos > this.pos;
  ...
  var Slider = {
    ...
    methods: {
      show: function (index, force) {
        ...
        var prev = hasClass(this.slides, this.clsActive) &&
            ...
            this.setItem(
              ...
              createEl(
                ...
                assign(
                  {
                    src:
                      ("https://www.youtube" + (matches[1] || "") +
                        ".com/embed/" + (matches[2]) + (matches[3]
                          ? ("?" + (matches[3]))
                          : "")),
                    width: 1920,
                    height: 1080,
  ...
  var notification = {
    ...
    created: function () {
      var container =
        ...
        append(
          this.container,
          '<div class="' + (this.clsContainer) + " " + (this.clsContainer) +
          "-" + (this.pos) + '" style="display: block"></div>',
        );

      this.$mount(
        append(
          container,
          '<div class="' + (this.clsMsg) + (this.status
            ? (" " + (this.clsMsg) + "-" + (this.status))
            : "") +
          '"> <a href class="' + (this.clsClose) +
      ...
      props: function (properties, $el) {
        ...
        return keys(props).reduce(function (result, prop) {
          if (!isUndefined(properties[prop])) {
            result[prop] = props[prop].call(
              this$1$1,
              prop,
              $el,
              properties[prop].slice(),
            );
          }
          return result;
        }, {});
  ...
  function setBackgroundPosFn(prop, steps, pos) {
    return function (css, percent) {
      css["background-position-" + prop] = "calc(" + pos + " + " +
        (getValue(steps, percent)) + "px)";
    };
  }
  ...
  function getBackgroundImage(el) {
    ...
    var src = css(el, "backgroundImage").replace(
      /^none|url\(["']?(.+?)["']?\)$/,
      "$1",
    );
  ...
  function getOffsetElement(el) {
    return el
      ? "offsetTop" in el ? el : getOffsetElement(parent(el))
      : document.documentElement;
  }
  ...
  var slider = {
    ...
    computed: {
      ...
      sets: function (ref) {
        ...
        sets = sortBy$1(this.slides, "offsetLeft").reduce(
          function (sets, slide, i) {
            ...
            if (slideRight > left) {
              ...
              if (!includes(sets, i)) {
                ...
                if (
                  ...
                  leftCenter = width;
                  sets.push(i);
                  left = slideLeft + width + (this$1$1.center
                    ? slideWidth / 2
                    : 0);
                }
              }
    ...
    update: {
      write: function () {
        ...
        this.navItems.forEach(function (el) {
          ...
          if (index !== false) {
            el.hidden = !this$1$1.maxIndex || index > this$1$1.maxIndex ||
    ...
    events: {
      beforeitemshow: function (e) {
        if (
          !this.dragging && this.sets && this.stack.length < 2 &&
    ...
    methods: {
      reorder: function () {
        ...
        var index = this.dir > 0 && this.slides[this.prevIndex] ? this.prevIndex
        : this.index;
        ...
        var width = dimensions(this.list).width / 2 -
          dimensions(next).width / 2;
        var j = 0;
  ...
  var sortable = {
    ...
    methods: {
      ...
      insert: function (element, target) {
        ...
        var insert = function () {
          return target ? before(target, element)
  ...
  function trackScroll(pos) {
    ...
    trackTimer = setInterval(function () {
      ...
      scrollParents(document.elementFromPoint(x, pos.y), /auto|scroll/)
        .reverse().some(function (scrollEl) {
  ...
  function findInsertTarget(list, target, placeholder, x, y, sameList) {
    ...
    var diff = placeholderRect[lengthProp] < rect[lengthProp]
      ? rect[lengthProp] - placeholderRect[lengthProp] : 0;
  ...
  function isHorizontal(list, placeholder) {
    ...
    var isHorizontal = items.some(function (el, i) {
      ...
      return items.slice(i + 1).some(function (el) {
        ...
        return !linesIntersect([rectA.left, rectA.right], [
          rectB.left,
          rectB.right,
        ]);
      });
  ...
  var tooltip = {
    ...
    methods: {
        ...
        this._unbind = once(
          ...
          function (e) {
            return e.type === pointerDown && !within(e.target, this$1$1.$el) ||
              ...
              e.type === "show" && e.detail[0] !== this$1$1 &&
      ...
      _show: function () {
        ...
        this.tooltip = append(
          this.container,
          '<div class="' + (this.clsPos) + '"> <div class="' + (this.clsPos) +
          '-inner">' + (this.title) + "</div> </div>",
        );
